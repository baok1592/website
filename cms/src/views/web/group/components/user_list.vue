					...
					<el-dialog title="" :visible.sync="add" width="420px">
						<el-form :model="form" label-width="100px">
							...
							<el-form-item label="昵称">
								<el-input v-model="form.nickname" v-if="eid==0" auto-complete="off"></el-input>
								<el-input v-model="form.nickname" v-else auto-complete="off"></el-input>
							</el-form-item>
				...
				<el-table :data="list" border style="width: 100%">
					...
					<el-table-column prop="operation" label="操作">
						<template slot-scope="scope">
								...
								<el-button type="success" size="small" @click="on_edit(scope.row.id,scope.row.username,
								scope.row.description,scope.row.group_id,scope.row.nickname)">编辑</el-button> 
...
<script>
	export default {
		...
		methods: {
			...
			//获取要修改人员的数据
			on_edit(id,name,dsc,gid,nickname){ 
				this.add = true;
				this.eid=id
