<template>
	<div class="header">
		...
		<el-button type="primary"  size="mini" @click="toindex(1)"  style="margin-right: 30px;margin-top: 20px; " vertical-align="middle">电 脑 首 页</el-button>
		<el-button type="primary" size="mini" @click="toindex(0)"  style="margin-right: 30px;margin-top: 20px;" vertical-align="middle">手 机 首 页</el-button>
		</br>
		<div class="head-img">
			...
			<el-dropdown trigger="click" @command="head">
				...
				<el-dropdown-menu slot="dropdown">
					<!-- <el-dropdown-item command="edit-xx">修改密码</el-dropdown-item> -->
